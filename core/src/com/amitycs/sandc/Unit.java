...
public class Unit {
	...
	private Map parent;
	// stuff above here should be final, but im dumb so it cant. Don't fuck with
	// it.

	public float food;
	public float morale;
	public float armsDurability; // also serves as resource value in the case of
									// carts
	...
	public Unit(float food, float morale, float armsDurability, float armorDurability, byte men, float movement,
			boolean team, UnitType type, Map parent, int[] location) {
		this.food = food;
		this.morale = morale;
	...
	public Unit(String team, String weapon, String armor, String food, String morale, String armsDurability,
			String armorDurability, String men, String movement, String location0, String location1, Map parent) {
	...
	public String toString() {
		return team + " " + type.toString() + " " + food + " " + morale + " " + armsDurability + " " + armorDurability
				+ " " + men + " " + movement + location[0] + location[1];
	}
}